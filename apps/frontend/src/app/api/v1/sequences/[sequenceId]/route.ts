 ...
 * GET /api/v1/sequences/[sequenceId] - Get a sequence by ID
 * PATCH /api/v1/sequences/[sequenceId] - Update a sequence
 * DELETE /api/v1/sequences/[sequenceId] - Delete a sequence
 */
...
export async function GET(
  ...
  try {
    ...
    console.error("[GET /api/v1/sequences/[sequenceId]] Error:", error);
...
export async function PATCH(
  ...
  try {
    ...
    console.error("[PATCH /api/v1/sequences/[sequenceId]] Error:", error);
    const handledError = handleApiError(error);
    return NextResponse.json(
      {
        success: false,
...
export async function DELETE(
  ...
  try {
    ...
    console.error("[DELETE /api/v1/sequences/[sequenceId]] Error:", error);
    const handledError = handleApiError(error);
    return NextResponse.json(
      {
        success: false,
