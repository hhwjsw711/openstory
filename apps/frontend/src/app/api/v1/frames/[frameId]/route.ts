/**
 * Frame API Endpoint
 * GET /api/v1/frames/[frameId] - Get a single frame
 * PATCH /api/v1/frames/[frameId] - Update a frame
 * DELETE /api/v1/frames/[frameId] - Delete a frame
 */
...
export async function GET(
  ...
  try {
    ...
    console.error("[GET /api/v1/frames/[frameId]] Error:", error);
...
export async function PATCH(
  ...
  try {
    ...
    console.error("[PATCH /api/v1/frames/[frameId]] Error:", error);
...
export async function DELETE(
  ...
  try {
    ...
    console.error("[DELETE /api/v1/frames/[frameId]] Error:", error);
