 ...
 * GET /api/v1/frames/sequences/[sequenceId]/frames - Get all frames for a sequence
 * DELETE /api/v1/frames/sequences/[sequenceId]/frames - Delete all frames for a sequence
 */
...
export async function GET(
  ...
  try {
    ...
    console.error(
      "[GET /api/v1/frames/sequences/[sequenceId]/frames] Error:",
      error,
    );
...
export async function DELETE(
  ...
  try {
    ...
    console.error(
      "[DELETE /api/v1/frames/sequences/[sequenceId]/frames] Error:",
      error,
    );
