 ...
 * GET /api/v1/frames/sequences/[sequenceId]/generation/active - Get active frame generation job for a sequence
 */
...
export async function GET(
  ...
  try {
    ...
    console.error(
      "[GET /api/v1/frames/sequences/[sequenceId]/generation/active] Error:",
      error,
    );
