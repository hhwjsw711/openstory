/**
 * Style API Endpoint
 * GET /api/v1/styles/[styleId] - Get a single style
 * PATCH /api/v1/styles/[styleId] - Update a style
 * DELETE /api/v1/styles/[styleId] - Delete a style
 */
...
export async function GET(
  ...
  try {
    ...
    console.error("[GET /api/v1/styles/[styleId]] Error:", error);
...
export async function PATCH(
  ...
  try {
    ...
    console.error("[PATCH /api/v1/styles/[styleId]] Error:", error);
...
export async function DELETE(
  ...
  try {
    ...
    console.error("[DELETE /api/v1/styles/[styleId]] Error:", error);
