 ...
 * POST /api/teams/[teamId]/invitations - Invite a member to the team (replaces /invite)
...
export async function POST(
  ...
  try {
    ...
    console.error("[POST /api/teams/[teamId]/invitations] Error:", error);
...
export async function GET(
  ...
  try {
    ...
    console.error("[GET /api/teams/[teamId]/invitations] Error:", error);
