...
describe.skip("Job Status API", () => {
  ...
  describe("GET /api/jobs/status/[id]", () => {
    it("should get job status successfully", async () => {
      ...
      const request = {
        url: `https://example.com/jobs/status/${testUUIDs.job1}`,
      } as NextRequest;
    ...
    it("should include events when requested", async () => {
      ...
      const request = {
        url: `https://example.com/jobs/status/${testUUIDs.job1}?includeEvents=true`,
      } as NextRequest;
    ...
    it("should exclude result when requested", async () => {
      ...
      const request = {
        url: `https://example.com/jobs/status/${testUUIDs.job1}?includeResult=false`,
      } as NextRequest;
    ...
    it("should return 404 for non-existent job", async () => {
      ...
      const request = {
        url: `https://example.com/jobs/status/non-existent`,
      } as NextRequest;
  ...
  describe("OPTIONS /api/jobs/status/[id]", () => {
