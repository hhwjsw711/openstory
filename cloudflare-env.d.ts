/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: ce78e0c0413c939ab67dd5d857c8ab42)
...
declare namespace Cloudflare {
  ...
  interface StgEnv {
    ...
    REALTIME: DurableObjectNamespace<import('./src/server').RealtimeChannelDO>;
  }
  interface PrdEnv {
    NEXT_INC_CACHE_R2_BUCKET: R2Bucket;
    R2_PUBLIC_ASSETS_BUCKET: R2Bucket;
