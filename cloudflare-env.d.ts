/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 894c263762328d78a7618e03023364ff)
// Runtime types generated with workerd@1.20260205.0 2025-11-18 nodejs_compat
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import('./server-cloudflare');
    durableNamespaces: 'RealtimeChannelDO';
  }
  interface StgEnv {
    ...
    EMAIL_FROM: string;
    EVAL_JUDGE_ENABLED: string;
    EVAL_JUDGE_MODEL: string;
    FAL_CONCURRENCY_LIMIT: string;
    FAL_KEY: string;
    ...
    REALTIME: DurableObjectNamespace<
      import('./server-cloudflare').RealtimeChannelDO
    >;
  }
  interface PrdEnv {
    NEXT_INC_CACHE_R2_BUCKET: R2Bucket;
