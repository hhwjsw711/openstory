...
export const Route = createFileRoute('/api/sequences/$sequenceId/frames')({
  server: {
    handlers: {
      GET: async ({ params }) => {
        try {
          ...
          console.error(
            '[GET /api/sequences/$sequenceId/frames] Error:',
            error
          );
      ...
      POST: async ({ request, params }) => {
        try {
          ...
          console.error(
            '[POST /api/sequences/$sequenceId/frames] Error:',
            error
          );
      ...
      DELETE: async ({ params }) => {
        try {
          ...
          console.error(
            '[DELETE /api/sequences/$sequenceId/frames] Error:',
            error
          );
