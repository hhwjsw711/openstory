...
export const stylePresets: Style[] = [
  createStylePreset({
    id: 'style-cinematic',
    name: 'Cinematic Epic',
    previewUrl: 'https://picsum.photos/seed/1536440136628-849c177e76a1/400/300',
    config: {
  ...
  createStylePreset({
    ...
    previewUrl: 'https://picsum.photos/seed/1578321272176-b7bbc0679853/400/300',
    config: {
  ...
  createStylePreset({
    id: 'style-noir',
    name: 'Film Noir',
    previewUrl: 'https://picsum.photos/seed/1518005020951-eccb494ad742/400/300',
    config: {
  ...
  createStylePreset({
    id: 'style-cyberpunk',
    name: 'Cyberpunk Neon',
    previewUrl: 'https://picsum.photos/seed/1549490349-8643362247b5/400/300',
    config: {
  ...
  createStylePreset({
    ...
    previewUrl: 'https://picsum.photos/seed/1557672172-298e090bd0f1/400/300',
    config: {
  ...
  createStylePreset({
    id: 'style-retro',
    name: 'Retro 80s',
    previewUrl: 'https://picsum.photos/seed/1557682250-33bd709cbe85/400/300',
    config: {
  ...
  createStylePreset({
    ...
    previewUrl: 'https://picsum.photos/seed/1567095761054-7a02e69e5c43/400/300',
    config: {
  ...
  createStylePreset({
    id: 'style-fantasy',
    name: 'Fantasy Epic',
    previewUrl: 'https://picsum.photos/seed/1618005198919-d3d4b5a92ead/400/300',
    config: {
  ...
  createStylePreset({
    ...
    previewUrl: 'https://picsum.photos/seed/1524985069026-dd778a71c7b4/400/300',
    config: {
  ...
  createStylePreset({
    id: 'style-comic',
    name: 'Comic Book',
    previewUrl: 'https://picsum.photos/seed/1579783902614-a3fb3927b6a5/400/300',
    config: {
  ...
  createStylePreset({
    ...
    name: 'Oil Painting',
    previewUrl: 'https://picsum.photos/seed/1579783928621-7a13d66a62d1/400/300',
    config: {
  ...
  createStylePreset({
    id: 'style-horror',
    name: 'Horror Dark',
    previewUrl: 'https://picsum.photos/seed/1566041510394-cf7c8fe21800/400/300',
    config: {
