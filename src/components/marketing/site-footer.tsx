    ...
    <footer className="mt-16 bg-foreground text-background sm:mt-24">
        ...
        >
          {duplicatedFilmstrip.map((src, i) => (
            <img
              ...
              alt=""
              loading="lazy"
              className="h-20 w-auto rounded-lg opacity-50 transition-opacity duration-300 hover:opacity-100"
            />
          ))}
        </div>
      </div>
      ...
      <div className="mx-auto max-w-7xl border-t border-background/[0.08] px-6">
        <div className="flex flex-col items-center justify-between gap-4 py-6 sm:flex-row">
          <p className="font-display text-xs tracking-widest text-background/25">
